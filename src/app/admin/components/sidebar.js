...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { name: "Transactions", icon: transactions, href: "/admin/admin-transactions" },
    { name: "Events", icon: eventIcon, href: "/admin/admin-event" },
    { name: "Push Notification", icon: pushIcon, href: "/admin/admin-push" },
    { name: "Roles & Permissions", icon: rolesIcon, href: "/admin/admin-roles" },
    { name: "Content Management", icon: contentIcon, href: "/admin/admin-content" },
    { name: "Interest Rate", icon: interestIcon, href: "/admin/admin-interest" },
    { name: "Customer Complaint", icon: customerIcon, href: "/admin/admin-customer" },
