...
import CreateHouseTypeModal from "../components/createHouseTypeModal";
import DeleteTypeModal from "../components/deleteHouseType";
...
const HouseType = () => {
  ...
  return (
    <>
      {showModal && (
        <CreateHouseTypeModal
          onClose={setShowModal}
          onTypeChange={() => setRefresh(!refresh)}
        />
      )}
      {showDeleteModal ? (
        <DeleteTypeModal
