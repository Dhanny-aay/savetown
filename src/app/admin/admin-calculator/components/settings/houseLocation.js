...
import CreateHouseLocationModal from "./createHouse";
...
const HouseLocation = () => {
  ...
  return (
    <>
      {showModal && <CreateHouseLocationModal onClose={setShowModal} />}
      ...
      <div>
        {selectedRows.length > 0 && (
          <div className='flex items-center justify-between'>
            <h2 className="font-Manrope text-sm md:text-base text-[#101828]">Are you sure you want to delete selected items?</h2>
