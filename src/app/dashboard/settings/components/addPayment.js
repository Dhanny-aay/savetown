...
import { handleCreateBankDetails } from "@/app/userControllers/bankController";
import { useSnackbar } from "notistack";

export default function AddPayment({ onClose, isVisible, triggerFetch }) {
  ...
  const handleSend = (e) => {
    if (validateFields()) {
      ...
      handleCreateBankDetails(userData, onSuccess, onError);
    }
  };
